    ...
    <div className="p-4 h-full">
      ...
      <div className="flex flex-col md:flex-row gap-4 md:h-[calc(100%-3.5rem)]"> {/* Adjusted height for md+ */}
        ...
        <div className="w-full md:w-2/3 space-y-3 md:overflow-y-auto md:pr-2"> {/* Added md: specific overflow and padding */}
            ...
            {moveData.flavorText && (
                <div className="bg-slate-700/50 p-3 rounded-md">
                <h3 className="font-semibold text-slate-200 mb-1">Game Description (X/Y):</h3>
        ...
        <div className="w-full md:w-1/3">
            ...
            <p className="text-xxs text-slate-500 mt-1">Note: List from PokeAPI data, may not reflect specific learnsets in X/Y (e.g. level-up, TM, tutor). Verify in-game.</p>
        </div>
      </div>
    </div>
  );
