  ...
  return (
    <div className="p-2 md:p-4 space-y-6 animate-fadeIn">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full p-3 bg-slate-800/60 border border-slate-700 rounded-md text-slate-100 placeholder-slate-400 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 outline-none transition-colors"
              disabled={isLoading}
          ...
          <button
            ...
            className="w-full md:w-auto px-6 py-2.5 bg-sky-600 hover:bg-sky-700 text-white font-semibold rounded-md shadow-md transition-all duration-150 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-2 focus:ring-offset-slate-900"
          >
      ...
      {apiResponse && !isLoading && !apiError && (
        <div className="bg-slate-800/70 p-4 md:p-6 rounded-lg shadow-xl animate-fadeIn backdrop-blur-sm border border-slate-700">
          ...
          <button
            onClick={handleResetAndClear}
            className="mt-4 px-5 py-2 bg-sky-600 hover:bg-sky-700 text-white font-medium rounded-md transition-colors shadow"
          >
